...
class Board(object):
    ...
    def display_board(self):
        ...
        print("------------------------------------------------------------------------")
        print(
            "|50" + p1p[49] + p2p[49] + "  |49" + p1p[48] + p2p[48] + "  |48"+p1p[47]+p2p[47]+"  |47"+p1p[46]+p2p[46] +
            "|46" + p1p[45] + p2p[45] + "|45"+p1p[44]+p2p[44]+"  |44"+p1p[43]+p2p[43]+"  |43"+p1p[42]+p2p[42]+"
        print(
        ...
        print("|  " + p3p[9] + p4p[9] + "  | L" + p3p[8] + p4p[8] + "  |  " + p3p[7] + p4p[7] + "  |  " + p3p[6] + p4p[
            6] + "  |  " + p3p[5] + p4p[5] + "  |  " + p3p[4] + p4p[4] + "  |  " + p3p[3] + p4p[3] + "  | L" + p3p[2] +
              p4p[2] + "  |  " + p3p[1] + p4p[1] + "  | L" + p3p[0] + p4p[0] + "  | ")
        print("------------------------------------------------------------------------")
...
def winner_grats():
    print("Congratuations we have a winner")
